...
class EWaste(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="ewastes", null=True
    )
...
class RWaste(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="rwastes", null=True
    )
...
class HWaste(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="hwastes", null=True
    )
...
class LSWaste(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="lswastes", null=True
    )
